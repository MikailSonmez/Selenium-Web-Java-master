...
Feature: Favorite Page
  ...
  Scenario Outline:  Empty Favorite Tab
    ...
    Examples:
      ...
      | mikail.snmz@gmail.com | Mikail.2000 | Favorilerim | Favori restoranınız bulunamadı |
  ...
  Scenario Outline:  Empty Favorite Page
    ...
    Examples:
      ...
      | mikail.snmz@gmail.com | Mikail.2000 | Favorilerim | Henüz favori restoranınız bulunmamaktadır. |
  ...
  Scenario Outline:  Add Favorite Restaurant
    ...
    Examples:
      ...
      | mikail.snmz@gmail.com | Mikail.2000 | Favorilerim | Süper Restoranlar | Ahmet Usta'nın Yeri |
  ...
  Scenario Outline:  Delete Favorite Restaurant
    ...
    Examples:
      ...
      | mikail.snmz@gmail.com | Mikail.2000 | Favorilerim | Ahmet Usta'nın Yeri | Henüz favori restoranınız bulunmamaktadır. |
